namespace MyWebCrawler.Service.Test.UI
{
    partial class FormReadCzceList
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtReg.Text = "<TR><TD class=title width=[\\w\\W]+?><A title=[\\w\\W]+? href=([\\w\\W]+?) target=_blan" +
    "k>([\\w\\W]+?)</A>[\\w\\W]+?</TD><TD width=75>([\\w\\W]+?)</TD></TR>";
            // 
            // txtUrl
            // 
            ...
            this.txtUrl.Text = "http://www.czce.com.cn/portal/jysdt/ggytz/A090601index_1.htm";
            // 
            // btnGo
            // 
